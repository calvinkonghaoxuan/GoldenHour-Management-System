...
public class ClockOutView {

    public ClockOutView(Stage stage) {

        // Make sure Login is ready for GUI
        Login.initForGUI();

        VBox root = new VBox(12);
        root.setStyle("-fx-padding: 20;");

        Label title = new Label("Clock Out");
        ...
        Label status = new Label("Not clocked out yet");

        Button clockOutBtn = new Button("Clock Out");
        clockOutBtn.setStyle("-fx-font-size: 14px;");
        ...
        clockOutBtn.setOnAction(e -> {
            ...
            if (time.startsWith("❌")) {
                ...
                status.setText("Clocked out at: " + time);
